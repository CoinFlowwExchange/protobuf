...
//
//	go build -ldflags "-X github.com/CoinFlowwExchange/protobuf/reflect/protoregistry.conflictPolicy=warn"
//
...
func (r *Files) checkGenProtoConflict(path string) {
	...
	currPath := "github.com/CoinFlowwExchange/protobuf/types/known/" + pkgName
	panic(fmt.Sprintf(""+
