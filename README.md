...
[![Go Reference](https://pkg.go.dev/badge/github.com/CoinFlowwExchange/protobuf.svg)](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf)
...
*   Code generator: The
    [`protoc-gen-go`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/cmd/protoc-gen-go)
...
*   Runtime library: The
    [`protobuf`](https://pkg.go.dev/mod/github.com/CoinFlowwExchange/protobuf) module
    ...
    [define what a message is](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/reflect/protoreflect)
    and functionality to serialize message in various formats (e.g.,
    [wire](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/proto),
    [JSON](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/encoding/protojson),
    and
    [text](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/encoding/prototext)).
...
implemented by the
[`github.com/CoinFlowwExchange/protobuf`](https://pkg.go.dev/mod/github.com/CoinFlowwExchange/protobuf)
...
*   [`proto`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/proto): Package
...
*   [`encoding/protojson`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/encoding/protojson):
    Package `protojson` serializes protobuf messages as JSON.
*   [`encoding/prototext`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/encoding/prototext):
    Package `prototext` serializes protobuf messages as the text format.
*   [`encoding/protowire`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/encoding/protowire):
...
*   [`reflect/protoreflect`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/reflect/protoreflect):
    Package `protoreflect` provides interfaces to dynamically manipulate
    protobuf messages.
*   [`reflect/protoregistry`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/reflect/protoregistry):
    Package `protoregistry` provides data structures to register and lookup
    protobuf descriptor types.
*   [`reflect/protodesc`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/reflect/protodesc):
    Package `protodesc` provides functionality for converting
    `descriptorpb.FileDescriptorProto` messages to/from the reflective
    `protoreflect.FileDescriptor`.
*   [`reflect/protopath`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/reflect/protopath):
    Package `protopath` provides a representation of a sequence of
    protobuf reflection operations on a message.
*   [`reflect/protorange`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/reflect/protorange):
    Package `protorange` provides functionality to traverse a protobuf message.
*   [`testing/protocmp`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/testing/protocmp):
    Package `protocmp` provides protobuf specific options for the `cmp` package.
*   [`testing/protopack`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/testing/protopack):
    Package `protopack` aids manual encoding and decoding of the wire format.
*   [`testing/prototest`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/testing/prototest):
    Package `prototest` exercises the protobuf reflection implementation for
    concrete message types.
*   [`types/dynamicpb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/dynamicpb):
    Package `dynamicpb` creates protobuf messages at runtime from protobuf
    descriptors.
*   [`types/known/anypb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/anypb):
    Package `anypb` is the generated package for `google/protobuf/any.proto`.
*   [`types/known/timestamppb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/timestamppb):
    Package `timestamppb` is the generated package for
    `google/protobuf/timestamp.proto`.
*   [`types/known/durationpb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/durationpb):
    Package `durationpb` is the generated package for
    `google/protobuf/duration.proto`.
*   [`types/known/wrapperspb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/wrapperspb):
    Package `wrapperspb` is the generated package for
    `google/protobuf/wrappers.proto`.
*   [`types/known/structpb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/structpb):
    Package `structpb` is the generated package for
    `google/protobuf/struct.proto`.
*   [`types/known/fieldmaskpb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/fieldmaskpb):
    Package `fieldmaskpb` is the generated package for
    `google/protobuf/field_mask.proto`.
*   [`types/known/apipb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/apipb):
    Package `apipb` is the generated package for
    `google/protobuf/api.proto`.
*   [`types/known/typepb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/typepb):
    Package `typepb` is the generated package for
    `google/protobuf/type.proto`.
*   [`types/known/sourcecontextpb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/sourcecontextpb):
    Package `sourcecontextpb` is the generated package for
    `google/protobuf/source_context.proto`.
*   [`types/known/emptypb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/known/emptypb):
    Package `emptypb` is the generated package for
    `google/protobuf/empty.proto`.
*   [`types/descriptorpb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/descriptorpb):
    Package `descriptorpb` is the generated package for
    `google/protobuf/descriptor.proto`.
*   [`types/pluginpb`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/types/pluginpb):
    Package `pluginpb` is the generated package for
    `google/protobuf/compiler/plugin.proto`.
*   [`compiler/protogen`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/compiler/protogen):
    Package `protogen` provides support for writing protoc plugins.
*   [`cmd/protoc-gen-go`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/cmd/protoc-gen-go):
...
*   **Internal changes**: We reserve the right to add, modify, and remove
    ...
    [`protoc-gen-go/internal_gengo`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/cmd/protoc-gen-go/internal_gengo)
    package, the
    [`runtime/protoimpl`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/runtime/protoimpl?tab=doc)
    package, and all packages under
    [`internal`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/internal).
...
[protobuf module](https://pkg.go.dev/mod/github.com/CoinFlowwExchange/protobuf). This
...
[`protoimpl.EnforceVersion`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/runtime/protoimpl?tab=doc#EnforceVersion)
...
The new
[`proto.Message`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/proto?tab=doc#Message)
interface contains a single `ProtoReflect` method that returns a
[`protoreflect.Message`](https://pkg.go.dev/github.com/CoinFlowwExchange/protobuf/reflect/protoreflect?tab=doc#Message),
